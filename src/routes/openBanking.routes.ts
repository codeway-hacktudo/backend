...
openBankingRoutes.get(
  ...
  openBankingController.getNaturalPersonFinancial
);
openBankingRoutes.get(
  "/open-banking/getBusinessFin",
  openBankingController.getNaturalBusinessFinancial
);
openBankingRoutes.get(
  "/open-banking/getPersonalQuali",
  openBankingController.getNaturalPersonQualification
);
openBankingRoutes.get(
  "/open-banking/getBusinessQuali",
  openBankingController.getBusinessPersonQualification
);
